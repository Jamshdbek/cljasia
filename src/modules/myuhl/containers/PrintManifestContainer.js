...
export const PrintManifestsTable = styled.div`
    width: 100%;
    @media print {
        thead {
...
const PrintManifestContainer = () => {
    ...
    const isManifestsAllDataFetched = useSelector((store) =>
        get(store, "myuhl.manifestAllSlice.data.loading", true)
    );
                    ...
                    <>
                        <Col xs={12} className={"mt-32 mb-64"} align="center">
                            <ReactToPrint
                                trigger={() => {
                                    return (
                                        <BaseButton primary>Печать</BaseButton>
                                    );
                                }}
...
export default PrintManifestContainer;
