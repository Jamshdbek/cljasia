...
const CityDealerContainer = () => {
  ...
  const paginationData = useSelector((store) =>
    get(
      store,
      "dealer.cityDealersPrices.data.cityDealersPrices.data.paginationData",
      []
    )
  );
        ...
        <Col xs={12} className={"mb-8"}>
          <BaseBreadcrumb
            items={[
              ...
              {
                id: 3,
                name: `${get(state, "dealerLastName", "")} ${get(
                  state,
                  "dealerName",
                  ""
                )} `,
                        ...
                        handleClick={() =>
                          history.push({
                            pathname:
                              ...
                              get(state, "dealerId", null),
                            state: {
                              dealerId: get(state, "dealerId", null),
                              dealerName: get(state, "dealerName", null),
                              dealerLastName: get(
                                state,
                                "dealerLastName",
                                null
                              ...
                              onClick={() =>
                                history.push({
                                  pathname:
                                    ...
                                    get(item, "priceId", null),
                                  state: {
                                    priceId: get(item, "priceId", null),
                                    dealerName: get(item, "dealerName", null),
                                    dealerLastName: get(
                                      state,
                                      "dealerLastName",
                                      null
                                    ...
                                    toCountryId: get(item, "toCountryId", null),
                                    toCountryName: get(
                                      item,
                                      "toCountryName",
                                      null
